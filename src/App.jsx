...
import NewSeasonAnime from './pages/NewSeasonAnime';
...
function App() {
  ...
  return (
    <Router>
      ...
      <Routes>
        <Route path="/" element={<Home changeMetaArr={changeMetaArr} />} /> {/* Home page */}
        <Route
          path="/popular"
        ...
        <Route
          path="/new-season"
          element={<NewSeasonAnime changeMetaArr={changeMetaArr} />}
        /> {/* New Seasons Anime page */}
        <Route
          path="/top100"
